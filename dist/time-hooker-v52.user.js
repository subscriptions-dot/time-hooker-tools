...
// @name            Time Hooker (V52.0 - Confirmed Learning + Safe Recipe Replay)

// @namespace       https://tampermonkey.net/

// @version         52.0

// @description     Fast-forwards supported timers and safely learns confirmed intermediate shortlink actions. V52 records only after real progress, replays through existing captcha/final-link/loop guards, and self-heals stale recipes.
...
(function() {
    ...
    const mainPageLogic = function(savedStr, remoteStr) {
        ...
        function commitPendingRecipe(pending) {
            ...
            existing.hits = Math.min(999, Number(existing.hits || 0) + 1);
        ...
        function recipeIsConfident(recipe) {
            ...
            return hits >= 3 && ratio >= 0.8 && fails < 2 && Number(recipe.consecutiveFails || 0) === 0 && Date.now() - Number(recipe.updatedAt || 0) < 30 * 86400000;
        ...
        function maybeRunLearnedRecipe(proxy) {
            ...
            if (evaluatePendingRecipe()) {
                ...
                setProxyStatus(proxy, 'LEARNING: confirming step');
            ...
            if (!localRecipe || !recipeIsConfident(localRecipe)) {
                ...
                return setUniversalManual(proxy, localRecipe ? 'LEARNED: confirm once' : 'LEARNED TEMPLATE: tap once', found.el);
        ...
        function maybeRunUniversalPatternFlow(proxy) {
            ...
            if (stepInfo) {
                ...
                if (stepInfo.btn6 && !stepInfo.btn6.dataset.thUniversalClicked) {
                    ...
                    stageRecipeAction(stepInfo.btn6, 'click');
